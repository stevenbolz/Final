...
-------------------------------------*/
function chosen_one() {
	var sect1_top = $('#HOME').offset().top - nav_height;
	var sect2_top = $('#GALLERY').offset().top - nav_height;
	var sect3_top = $('#PEOPLE OF PERU').offset().top - nav_height;
	var sect4_top = $('#CONTACT').offset().top - nav_height;
	var sect5_top = $('#LOGIN').offset().top - nav_height;
